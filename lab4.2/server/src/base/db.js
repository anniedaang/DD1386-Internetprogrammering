...
await insertDoc.run("20000001", "assistant1", "Test Document 1", "This is a test document");
await insertDoc.run("20000002", "assistant1", "Test Document 2", "This is a test document");
await insertDoc.run("20000003", "assistant2", "Test Document 3", "This is a test document");
await insertDoc.run("20000004", "assistant2", "Test Document 4", "This is a test document");
await insertDoc.run("20000005", "assistant3", "Test Document 5", "This is a test document");
await insertDoc.run("20000006", "assistant3", "Test Document 6", "This is a test document");
insertDoc.finalize();
